...
// Use https:// for serverless environments (Vercel) — more reliable than WebSockets.
// libsql:// is auto-converted; file: URLs for local dev are passed through unchanged.
